...
public class CategoryController : MonoBehaviour
{
    ...
    public static categories FromString(string category){ //TODO: add polish translation
        if(category == "Для дітей" || category == "For kids" || category == "Dla dzieci"){
            return categories.child;
        } else if(category == "18+"){
            return categories.adult;
        } else if(category == "Цікаве" || category == "Interesting" || category == "Ciekawy"){
